                    ...
                    <tbody>
                        <?php foreach ($contacts as $contact) : ?>
                            <tr>
                                ...
                                <td><a href="/contacts/edit/<?= $this->e($contact->id) ?>" class="btn btn-xs btn-warning">
                                        <i alt="Edit" class="fa fa-pencil"> Edit</i></a>
                                    <form class="delete" action="/contacts/delete/<?= $this->e($contact->id) ?>" method="POST" style="display: inline;">
