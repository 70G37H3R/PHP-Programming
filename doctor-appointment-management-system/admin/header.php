    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Bảng Điều Hướng</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="doctor.php">
                    ...
                    <span>Bác Sĩ</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="patient.php">
                    <i class="fas fa-procedures"></i>
                    <span>Bệnh Nhân</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="doctor_schedule.php">
                    ...
                    <span>Lịch Bác Sĩ</span></a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link" href="appointment.php">
                    <i class="fas fa-notes-medical"></i>
                    <span>Lịch Hẹn Bệnh Nhân</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="prescription.php">
                    <i class="fas fa-capsules"></i>
                    <span>Đơn Thuốc</span></a>
            </li>
            <?php
            if($_SESSION["type"] == 'Admin')
            {
