...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Quản Lý Lịch Bác Sĩ</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">Danh Sách Lịch Bác Sĩ</h6>
                            	</div>
    	...
    	<form method="post" id="doctor_schedule_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Thêm Mới Lịch Bác Sĩ</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="average_consulting_time" id="average_consulting_time" class="form-control" required>
                                <option value="">Chọn Thời Gian Khám</option>
                                <?php
                                $count = 0;
                                for($i = 1; $i <= 15; $i++)
                                {
                                    $count += 5;
                                    echo '<option value="'.$count.'">'.$count.' Phút</option>';
                                }
                                ?>
                            </select>
                        </div>
...
$(document).ready(function(){
	...
	$('#add_doctor_schedule').click(function(){
    	...
    	$('#modal_title').text('Thêm Mới Lịch Bác Sĩ');
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text('Cập Nhật Thông Tin Chi Tiết Lịch Bác Sĩ');
