...
<div class="container">
	<div class="row justify-content-md-center">
		<div class="col col-md-4">
			...
			<div class="card">
				<div class="card-header">Bệnh Nhân Đăng Nhập</div>
				<div class="card-body">
					<form method="post" id="patient_login_form">
						...
						<div class="form-group text-center">
							...
							<input type="submit" name="patient_login_button" id="patient_login_button" class="btn btn-primary" value="Đăng Nhập" />
						</div>

						<div class="form-group text-center">
							<p><a href="register.php">Chưa Có Tài Khoản? Đăng Kí</a></p>
						</div>
					</form>
				</div>
			</div>
